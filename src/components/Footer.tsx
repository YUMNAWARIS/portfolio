  ...
  return (
    <Box component="footer" sx={{ borderTop: 1, borderColor: "divider", py: 4, mt: 8, position: "relative", overflow: "hidden",
      ...
      <Container sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, justifyContent: "space-between", alignItems: "center", gap: 2 }}>
        <Typography variant="body2" suppressHydrationWarning>© {new Date().getFullYear()} Yumna. All rights reserved.</Typography>
        <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
          ...
          <Typography variant="body2" component={Link} href="https://www.linkedin.com/in/yumna-waris" target="_blank" rel="noopener noreferrer">
            LinkedIn
          </Typography>
        </Box>
      </Container>
